...
const EMAIL_TPLS = [
  ...
  {
    name: "光纤回路器询价",
    desc: "向回路器/Loopback 供应商询价（SC/LC/MPO 多规格）",
    subject: "关于贵司光纤回路器（Loopback）的询价",
    body: "客户您好：\n\n我是{{我方公司}}的{{自己}}，此前我司曾向贵司发送过一份询价邮件，因邮件格式问题，现以此份为准，重新确认询价：\n\n目前正在为一批项目筛选光纤回路器（Loopback）供应商，看到贵司产品线中有相关产品，想向您询几个型号的报价：\n\n1. SC/UPC 单模光纤回路器\n2. LC/UPC 单模光纤回路器\n3. LC/UPC 多模 OM3/OM4 光纤回路器\n4. MPO/MTP 12芯回路器（如可提供）\n\n请帮忙确认以下信息：\n- 含税单价（起订量 1 个 / 100 个 / 1000 个）\n- 常用规格的交货周期\n- 是否支持定制（外壳颜色、标签、包装）\n- 产品插入损耗 / 回波损耗典型值\n\n如果方便，也请发一份带规格参数的电子画册或报价单，收到后我会尽快确认。\n\n期待回复，谢谢！\n\n此致敬礼\n\nEason\n电话：18688962816\n{{我方公司}} {{自己}}",
  },
  {
    name: "通用采购询价",
    desc: "首次接触供应商：报价+画册+资质",
    subject: "关于贵司{{产品}}的采购询价",
    body: "{{联系人}}您好：\n\n我是{{我方公司}}的{{自己}}，我司长期采购与分销{{产品}}，目前正在筛选优质供应商。看到贵司产品线与我们的需求比较匹配，想先了解几点：\n\n1. 常供型号清单及含税报价（不同起订量）；\n2. 常用规格的库存与交货周期；\n3. 是否支持样品测试及样品政策；\n4. 相关资质证书（ISO/CE/RoHS 等）。\n\n如方便，请发一份电子画册或报价单，收到后我会尽快确认并安排后续沟通。\n\n期待回复，谢谢！\n{{我方公司}} {{自己}}",
  },
  {
    name: "多规格比价询价",
    desc: "一次询多个规格，横向比价用",
    subject: "{{产品}}多规格询价（附清单）",
    body: "{{联系人}}您好：\n\n我是{{我方公司}}的{{自己}}，近期有{{产品}}的采购计划，想请贵司按以下规格分别报价：\n\n- 规格1：____________（型号/芯数/接口）\n- 规格2：____________（型号/芯数/接口）\n- 规格3：____________（型号/芯数/接口）\n\n请按三种数量档（小批量 / 中批量 / 大批量）提供含税单价，并注明：\n1. 起订量（MOQ）与交期；\n2. 关键性能指标（如插损、回损）典型值；\n3. 包装方式与质保期；\n4. 是否支持定制（标签、颜色、包装、OEM）。\n\n收到报价后我会尽快确认采购意向，感谢配合！\n{{我方公司}} {{自己}}",
  },
  {
    name: "项目合作询价",
    desc: "针对具体项目/招标的定向询价",
    subject: "关于{{地区}}项目配套的询价与合作",
    body: "{{联系人}}您好：\n\n我是{{我方公司}}的{{自己}}，我司目前有{{地区}}相关的项目配套需求（{{产品}}），项目时间较紧，优先考虑能快速响应、常备现货的供应商。\n\n想确认以下几点：\n1. 常用规格是否有现货，能否按项目工期交付；\n2. 项目批量价格政策；\n3. 是否能提供技术参数资料、检测报告；\n4. 是否支持按项目定制。\n\n如贵司可满足，请尽快回复并提供报价，我们会在1-2天内确认。\n\n期待与贵司合作！\n{{我方公司}} {{自己}}",
  },
  {
    name: "样品测试询价",
    desc: "向供应商申请样品做插损/回损测试",
    subject: "申请{{产品}}样品测试",
    body: "{{联系人}}您好：\n\n我是{{我方公司}}的{{自己}}，我们正在评估{{产品}}供应商，希望申请贵司样品进行测试（插损、回损、兼容性等）。\n\n请告知：\n1. 样品是否免费，或样品费用与快递费如何结算；\n2. 可提供的型号与规格；\n3. 样品随附的测试数据/出厂报告；\n4. 测试通过后的批量采购政策与价格。\n\n样品测试通过后，我们会按计划安排批量订单，期待建立长期合作。\n\n谢谢！\n{{我方公司}} {{自己}}",
  },
  {
    name: "报价跟进",
    desc: "发询价后未回复时的跟进催报价",
    subject: "询价跟进：{{产品}}（{{公司}}）",
    body: "{{联系人}}您好：\n\n之前给您发过关于{{产品}}的询价，不知是否收到？我们近期的采购计划还在确认中，如果能尽快提供报价，便于我们纳入比价清单。\n\n如需补充任何信息（规格清单、数量、交期要求等），请随时告诉我。期待您的回复！\n\n祝生意兴隆！\n{{我方公司}} {{自己}}",
  },
  {
    name: "长期合作询价",
...
async function renderSettings() {
  ...
  el.innerHTML = `
    ...
    <div class="card">
      ...
      <div class="form-grid">
        ...
        <div class="field"><label>抄送邮箱（每封自动抄送一份给自己）</label><input class="input full" id="s-cc" placeholder="留空表示不抄送" value="${esc(s.cc_addr)}"></div>
  ...
  $("#save-settings").onclick = async () => {
    ...
    try {
      ...
      if (searchProv === "serpapi" && searchKey && !/^[a-fA-F0-9]{64}$/.test(searchKey)) {
        throw new Error("SerpAPI 密钥应为 64 位十六进制字符，请检查是否粘贴了其它内容");
      }
      await api("/api/settings", { method: "POST", body: { settings: {
